...
1. Provide context and explanations about the task organization principles you've applied
...
PART 1: Add to the JSON Array your explanaition explanation section where you: (text-only dont mention the JSON format)
...
IMPORTANT: not mention "PART 1" OR "PART 2" OR "JSON data block" OR "JSON data" in your response
`
